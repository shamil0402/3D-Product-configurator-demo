...
export function Elemetsolo(props) {
    ...
    const { nodes, materials } = useGLTF('models/new/ElementSolo.glb')

    const feltMaterial = useFeltMaterial('ElementSolo-Interior-AO-furniture', 4, 4)
    const carpetMaterial = useCarpettMaterial('ElementSolofbx-Carpet-AO-furnirue', 4, 4)
        ...
        <group {...props} dispose={null}>
            <group scale={0.01}>
                ...
                <mesh
                    castShadow
                    receiveShadow
                    geometry={nodes.DooreWindow001.geometry}
